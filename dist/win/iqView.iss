...
#define MyAppVersion "1.0-AI"
#define MyAppYear "2026"

[Setup]
AppId={{B7A9BAAB-C59E-4EAB-ACE1-3EEDE3031881}
AppName={#MyAppName}
...
#elif "MyArch" == "arm64"
OutputBaseFilename={#MyAppName}-{#MyAppVersion}-winarm64-setup
#else
...
[Files]
#if "MyArch" == "x86"
Source: "iqView-Win32/*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
#elif "MyArch" == "arm64"
Source: "iqView-WinArm64/*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
#else
...
Root: HKA; Subkey: "Software\{#MyAppName}\Capabilities"; ValueType: string; ValueName: "ApplicationDescription"; ValueData: "Practical and minimal AI-enhanced image viewer"; Tasks: fileassociation
...
Root: HKA; Subkey: "Software\RegisteredApplications"; ValueType: string; ValueName: "iqView"; ValueData: "Software\iqView\Capabilities"; Flags: uninsdeletevalue; Tasks: fileassociation
...
begin
  ...
  begin
        if SuppressibleMsgBox('Do you want to also delete saved settings and AI cache?',
      mbConfirmation, MB_YESNO, IDYES) = IDYES
    then
    begin
      RegDeleteKeyIncludingSubkeys(HKEY_CURRENT_USER, 'Software\iqView');
      RegDeleteKeyIncludingSubkeys(HKEY_LOCAL_MACHINE, 'Software\iqView');
      RegDeleteKeyIncludingSubkeys(HKEY_LOCAL_MACHINE, 'Software\WOW6432node\iqView');
    end;
  end;
end;
